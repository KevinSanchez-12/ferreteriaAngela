<?php
    ...
    $pdf->MultiCell(0,5,utf8_decode(strtoupper("Ferretería Angela")),0,'C',false);
    $pdf->SetFont('Arial','',9);
    ...
    $pdf->MultiCell(0,5,utf8_decode("Representación impresa de la ".$nuevoComprobante." de venta electrónica desarrollada y elaborada por Cañete L@b"),0,'C',false);
