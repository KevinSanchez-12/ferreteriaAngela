<?php
    ...
    $pdf->MultiCell(0,5,utf8_decode(strtoupper("Empresa")),0,'C',false);
    $pdf->SetFont('Arial','',9);
    $pdf->MultiCell(0,5,utf8_decode($sede),0,'C',false);
    $pdf->MultiCell(0,5,utf8_decode("RUC: 10101397608"),0,'C',false);
    $pdf->MultiCell(0,5,utf8_decode("De: xxxxxxxxxxxxx"),0,'C',false);
    ...
    $pdf->MultiCell(0,5,utf8_decode("Representación impresa de la ".$nuevoComprobante." de venta electrónica desarrollada y elaborada por Kevin Sánchez"),0,'C',false);
